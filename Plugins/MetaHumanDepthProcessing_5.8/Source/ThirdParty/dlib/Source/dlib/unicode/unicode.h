...
#if (defined(__GNUC__) && __GNUC__ < 4 && __GNUC_MINOR__ < 4) || defined(_LIBCPP_VERSION) //@UE5 also use unichar_traits with libc++, which does not provide char_traits for unsigned integer types
