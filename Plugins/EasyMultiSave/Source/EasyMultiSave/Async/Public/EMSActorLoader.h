...
public:
    ...
    FLoaderInitData(bool bInStreaming, const TArray<FActorSaveData>& InData, const TMap<FActorByteKey, TWeakObjectPtr<AActor>>& InMap)
        : bIsStreaming(bInStreaming), InActorData(InData), InActorMap(InMap)
    {
    }
};
