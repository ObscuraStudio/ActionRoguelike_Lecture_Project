...
public:
	...
	static bool IsSafeToDelete(const FString& AbsoluteBaseDir, const FString& InputFolder);
	static bool DeleteSaveDirectory(const FString& BaseDir, const FString& InputName, const FString& Context);
};
