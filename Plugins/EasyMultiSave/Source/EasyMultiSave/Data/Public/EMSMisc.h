...
public:
	...
	static bool IsSaveReportEnabled();
};
...
public:
	...
	static bool IsAsyncSaveOrLoadTaskActive(const UWorld* InWorld, const ESaveGameMode Mode, const bool bLog);
	...
	static bool IsWorldTearingDown(const UWorld* World);
